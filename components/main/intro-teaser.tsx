	...
	return (
		<section className="py-32 bg-slate-900 text-center overflow-hidden">
			<div className="max-w-5xl mx-auto px-6 w-full">
				<FadeIn>
					<h2 className="text-lg md:text-xl text-blue-400 font-bold mb-8 tracking-widest">
						WAVE ON은 어떤 파도를 만드나요?
					</h2>
					<p className="text-[1.8rem] md:text-5xl font-semibold leading-tight text-white mb-12">
						“AI 시대에도, 우리는 여전히
						<br />
					...
					<p className="text-lg text-slate-400 mb-12 max-w-2xl mx-auto">
						공연, 전시, 팝업스토어를 통해 청춘의 <br className="md:hidden" />
						에너지를 <br className="hidden md:block" />
						파도처럼 번지게 만들어요.
					</p>
					<Link
						href="/about"
